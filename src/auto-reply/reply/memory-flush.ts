...
export const DEFAULT_MEMORY_FLUSH_PROMPT = [
  ...
  "",
  "Write memory entries as plain markdown. Do not include YAML frontmatter (grade, fact_type, tags) — these are managed automatically by the memory lifecycle system.",
  "",

...
export const DEFAULT_MEMORY_FLUSH_PROMPT = [
  ...
  "",
  "STRUCTURED MEMORY FORMAT: Each memory entry MUST include YAML frontmatter with grade, fact_type, and tags.",
  "Format each entry as:",
  "```",
  "---",
  "grade: <ephemeral|recurring|permanent>",
  "fact_type: <W|B|O|S>",
  "tags: [tag1, tag2]",
  "---",
  "<memory content>",
  ...
  "- W (Worldview): objective facts about the world or user. e.g. 'Lives in Seoul', 'Is a developer'",
  "- B (Belief): principles, convictions. e.g. 'Stop-loss should be mechanical', 'TDD matters'",
  "- O (Opinion): preferences, tastes. e.g. 'Likes mala tang', 'Prefers dark mode'",
  "- S (Strategy): plans, goals. e.g. 'This month goal is X', 'Project A has priority'",
  "",
  "Initial grade rules:",
  "- W/B → recurring (promote to permanent after validation)",
  "- O/S → ephemeral (promote to recurring if repeated)",
  "",
